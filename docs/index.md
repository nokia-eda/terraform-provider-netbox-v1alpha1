---
page_title: "netbox-v1alpha1 Provider"
---

# netbox-v1alpha1 Provider

This provider is used to interact with the resources provided by the **netbox-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
