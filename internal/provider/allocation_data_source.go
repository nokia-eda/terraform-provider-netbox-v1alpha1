...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-netbox/internal/datasource_allocation"
...
const read_ds_allocation = "/apps/netbox.eda.nokia.com/v1alpha1/namespaces/{namespace}/allocations/{name}"

var (
	_ datasource.DataSource              = (*allocationDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*allocationDataSource)(nil)
)
...
func (d *allocationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_allocation.AllocationModel
	...
	err = d.client.GetByQuery(ctx, read_ds_allocation, map[string]string{
...
func (r *allocationDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
