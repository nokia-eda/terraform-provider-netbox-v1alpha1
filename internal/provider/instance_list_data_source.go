...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-netbox/internal/datasource_instance_list"
...
const read_ds_instanceList = "/apps/netbox.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances"
