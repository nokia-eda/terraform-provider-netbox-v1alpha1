...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-netbox/internal/eda/utils"
...
func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &netboxProvider{version: ver}
	}
}
