...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-netbox/internal/datasource_instance"
...
const read_ds_instance = "/apps/netbox.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances/{name}"
