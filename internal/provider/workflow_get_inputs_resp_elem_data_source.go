...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-netbox/internal/datasource_workflow_get_inputs_resp_elem"
...
const read_ds_workflowGetInputsRespElem = "/workflows/v1/netbox.eda.nokia.com/v1alpha1/namespaces/{namespace}/applyallocations/{name}/_input"
