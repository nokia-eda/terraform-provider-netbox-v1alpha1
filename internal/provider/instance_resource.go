...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-netbox/internal/resource_instance"
	"github.com/nokia/eda/apps/terraform-provider-netbox/internal/tfutils"
)

const (
	create_rs_instance = "/apps/netbox.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances"
	read_rs_instance   = "/apps/netbox.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances/{name}"
	update_rs_instance = "/apps/netbox.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances/{name}"
	delete_rs_instance = "/apps/netbox.eda.nokia.com/v1alpha1/namespaces/{namespace}/instances/{name}"
)
