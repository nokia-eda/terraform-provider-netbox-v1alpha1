...
package datasource_apply_allocation_list
...
func ApplyAllocationListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ApplyAllocationListModel struct {
