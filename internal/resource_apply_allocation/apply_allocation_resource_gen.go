...
package resource_apply_allocation
...
func ApplyAllocationResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ApplyAllocation$"), ""),
				},
				Default: stringdefault.StaticString("ApplyAllocation"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the ApplyAllocation",
				MarkdownDescription: "name of the ApplyAllocation",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"allocation": schema.StringAttribute{
						...
						MarkdownDescription: "Allocation reference",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				Required:            true,
				Description:         "spec defines the desired state of ApplyAllocation",
				MarkdownDescription: "spec defines the desired state of ApplyAllocation",
			},
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "status defines the observed state of ApplyAllocation",
				MarkdownDescription: "status defines the observed state of ApplyAllocation",
			},
		},
	}
}

type ApplyAllocationModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	allocationAttribute, ok := attributes["allocation"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`allocation is missing from object`)

		return nil, diags
	}

	allocationVal, ok := allocationAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`allocation expected to be basetypes.StringValue, was: %T`, allocationAttribute))
	}
...
type SpecValue struct {
	Allocation basetypes.StringValue `tfsdk:"allocation"`
	state      attr.ValueState
}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["allocation"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Allocation.ToTerraformValue(ctx)
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		"allocation": basetypes.StringType{},
	}
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.Allocation.Equal(other.Allocation) {
		return false
	}
